...
public class App : IExternalApplication
{
    ...
    private RibbonPanel RibbonPanel(UIControlledApplication application)
    {
        ...
        RibbonPanel panel = CachedUiCtrApp.CreateRibbonPanel("RevitAddin2_Panel");
        panel.Title = "RevitAddin2";
        ...
        PushButton button = (PushButton)panel.AddItem(
            new PushButtonData(
                ...
                $"{nameof(RevitAddin2)}.{nameof(Commands)}.{nameof(Command)}"));
        button.ToolTip = "Execute the RevitAddin2 command";
        button.LargeImage = PngImageSource("RevitAddin2.Resources.RevitAddin2_Button.png");
