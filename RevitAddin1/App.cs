...
public class App : IExternalApplication
{
    ...
    private RibbonPanel RibbonPanel(UIControlledApplication application)
    {
        ...
        RibbonPanel panel = CachedUiCtrApp.CreateRibbonPanel("RevitAddin1_Panel");
        panel.Title = "RevitAddin1";
        ...
        PushButton button = (PushButton)panel.AddItem(
            new PushButtonData(
                ...
                $"{nameof(RevitAddin1)}.{nameof(Commands)}.{nameof(Command)}"));
        button.ToolTip = "Execute the RevitAddin1 command";
        button.LargeImage = PngImageSource("RevitAddin1.Resources.RevitAddin1_Button.png");
